...
function shiftDown(currentIdx, endIdx, heap, animations) {
    ...
    while (childOneIdx <= endIdx) {
        ...
        if (childTwoIdx !== -1 && heap[childTwoIdx] > heap[childOneIdx] && noteComparison(childTwoIdx, childOneIdx, animations)) {
            idxToSwap = childTwoIdx;
        } else {
            idxToSwap = childOneIdx;
        }
        if (heap[idxToSwap] > heap[currentIdx] && noteComparison(idxToSwap, currentIdx, animations)) {
